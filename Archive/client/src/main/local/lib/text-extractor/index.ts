...
export class TextExtractionError extends Error {
  constructor(
    message: string,
    public readonly code: 'UNSUPPORTED_TYPE' | 'EXTRACTION_FAILED' | 'FILE_TOO_LARGE' = 'EXTRACTION_FAILED'
  ) {
    super(message)
...
export async function extractTextFromFile(
  ...
  try {
    ...
    const message = error instanceof Error ? error.message : 'Unknown error extracting text'
    throw new TextExtractionError(
